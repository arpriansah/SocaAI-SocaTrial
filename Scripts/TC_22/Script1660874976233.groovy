...
WebUI.click(findTestObject('Object Repository/fr07/Page_soca.ai/a_Sign In'))

WebUI.setText(findTestObject('Object Repository/fr07/Page_soca-dashboarduser/input_Email_form-control'), 'socatrial@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/fr07/Page_soca-dashboarduser/input_Password_form-control mb-2'), 
    'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/fr07/Page_soca-dashboarduser/button_Sign In'))

WebUI.click(findTestObject('Object Repository/fr07/Page_soca-dashboarduser/button_OK'))

WebUI.click(findTestObject('Object Repository/fr07/Page_soca-dashboarduser/a_Projects'))

WebUI.click(findTestObject('Object Repository/fr07/Page_soca-dashboarduser/button_Dashboard'))

WebUI.click(findTestObject('Object Repository/fr07/Page_soca-ai-proctoring-dashboard/span_Schedule'))

WebUI.selectOptionByValue(findTestObject('Object Repository/fr07/Page_soca-ai-proctoring-dashboard/select_--Select Event Name--TestingTesting _1e444c'), 
...
WebUI.click(findTestObject('fr07/Page_soca-ai-proctoring-dashboard/button_minutes_start_time'))
