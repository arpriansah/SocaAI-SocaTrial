...
WebUI.setText(findTestObject('Object Repository/fr04/Page_soca-ai-proctoring-dashboard/input_Event Name_event_name'), 'Testing')

WebUI.setText(findTestObject('Object Repository/fr04/Page_soca-ai-proctoring-dashboard/input_Event Type_event_type'), '')
